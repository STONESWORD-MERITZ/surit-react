...
const SECTIONS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body:
      "수집된 개인정보는 (1) 회원 식별 및 로그인 유지, (2) 업로드된 PDF의 고지 리스크 항목 추출·분석 결과 제공, (3) 서비스 부정이용 방지·법적 의무 이행 목적에 한해 사용됩니다. 수집 시점에 명시한 목적 외의 용도로는 사용되지 않습니다.",
  },
  {
  ...
  },
  {
    ...
    body:
      "본 서비스가 처리하는 진료내역에는 개인정보보호법 제23조에 따른 민감정보(건강에 관한 정보)가 포함됩니다. 이용자는 분석 시작 전 별도 동의 절차를 통해 민감정보 처리에 동의해 주셔야 합니다. 설계사 등 제3자가 고객 자료를 업로드하는 경우 정보주체의 적법한 동의를 확보해야 합니다. 동의를 거부할 권리가 있으며, 거부 시 분석 서비스 제공이 제한될 수 있습니다.",
  },
  {
...
export default function PrivacyPolicy() {
  return (
    <main className="mx-auto max-w-3xl px-5 py-10">
      ...
      <p className="mt-2 text-xs text-gray-400">최종 개정 시행일: {COMPANY.effectiveDate}</p>
