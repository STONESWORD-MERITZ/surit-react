...
const SECTIONS: { title: string; body: string }[] = [
  {
    title: "제1조 (목적)",
    body:
      "본 약관은 BOHUMFIT(보험핏, 이하 '회사')이 제공하는 보험 고지 리스크 점검 서비스(이하 '서비스')의 이용과 관련하여 회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.",
  },
  {
    title: "제2조 (서비스의 정의)",
    body:
      "본 서비스는 이용자가 업로드한 건강보험심평원 PDF 자료를 기반으로 보험 가입 또는 보험금 청구 시 확인해야 할 고지 검토 항목을 AI 보조 분석 도구를 통해 정리하여 제공하는 정보 서비스입니다.",
  },
  {
    title: "제3조 (서비스의 책임 한계)",
    body:
      "① 본 서비스가 제공하는 분석 결과는 참고용 보조 정보이며, 보험 가입·인수·보험금 지급을 보장하지 않습니다. 보험 가입·청구의 최종 결정은 보험회사의 청약서 문항, 언더라이팅 정책 및 약관에 따라 이루어집니다.\n" +
